...
public class AppTest {
    ...
    public void MyBookFiles() throws IOException {
        ...
        Book b1= new Book("book1", "chaithanya");
        int ID=b1.getID();
        // assertEquals("bookfiles-5", "No books was found.", MyBookFiles.showBooks());
        assertEquals("bookfiles-1", "Book added to system.", b1.save());
        assertEquals("bookfiles-2", b1, MyBookFiles.getBook("book1", "chaithanya"));
        assertEquals("bookfiles-3", b1, MyBookFiles.getBook(ID));
        assertEquals("bookfiles-4",true, MyBookFiles.checkForBook("book1", "chaithanya"));
        MyBookFiles.readBooks();
        Book b2= new Book("book2", "chaithanya1");
    ...
    public void MyManagerFiles() throws IOException {
        ...
        Manager m1=new Manager("chaithanya", 970);
        int ID=m1.getID();
        ...
        MyManagerFiles.readManagers();
        Manager m2=new Manager("chaithanya2", 9948);
    ...
    public void MyRentFiles() throws IOException{
        ...
        // Manager man = new Manager("Tim", 456);
        Member m1=new Member("chaithanya", 970);
        ...
        assertEquals("rentfiles-0","chaithanya rented "+b1.getName()+"("+b1.getID()+") at "+r1.getDate()+".\n", output.toString());
        output.close();
        
        output = new ByteArrayOutputStream();
        System.setOut(new PrintStream(output));
        MyRentFiles.showRents(0);
        assertEquals("rentfiles-1", "chaithanya rented "+b1.getName()+"("+b1.getID()+") at "+r1.getDate()+".\n", output.toString());
        output.close();
    ...
    public void ManagerCLI5() throws IOException{
        Manager m1=new Manager("chaithanya99", 994819);
        m1.save();
        String enterName="Enter your name ('0' to return): Enter your nationalCode ('0' to return): ";
    ...
    public void ManagerCLI8() throws IOException{
        ...
        MyBookFiles.remove(MyBookFiles.getBook("Skullduggery Pleasant Dark Days", "Derek Landy"));
        MyBookFiles.remove(MyBookFiles.getBook("Skullduggery Pleasant Dark Days", "Derek Landy"));
        MyBookFiles.remove(MyBookFiles.getBook("book1", "chaithanya"));
        Manager m1=new Manager("madhav", 5454);
        m1.save();
        int ID=Manager.getStaticID()-1;
        String input="1\n1\n"+ID+"\n1\n1\n2\n0\n2\nsdlfkj\n0\n2\ncha\nchat\n2\ncha\nchat\n3\n0\n3\ncha\n0\n3\ndskfj\nkdlsfj\n3\ncha\nchat\n4\n6\n3\n3\n"+"4\n6\n3\n3\n"+"4\n6\n3\n3\n"+"4\n6\n3\n3\n"+"4\n6\n3\n3\n6\n3\n3\n3\n3\n";
    ...
    public void MembersCLI7() {
        MyBookFiles.remove(MyBookFiles.getBook("sdlfkj", "0"));
        MyBookFiles.remove(MyBookFiles.getBook("sdlfkj", "0"));
        int ID=Member.getStaticID();
        String input = "2\n2\nHey\n122\n1\n" + ID + "\n1\n1\n4\n5\n3\n3\n3\n3\n3\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
